...
import tool.DeleteByIdsElementGenerator;
...
public class DefaultGeneratorPlugin extends PluginAdapter {
    ...
    public boolean sqlMapGenerated(GeneratedXmlFile sqlMap, IntrospectedTable introspectedTable) {
        ...
        tool.SelectByConditionElementGenerator selectOneElementGenerator = new tool.SelectByConditionElementGenerator();
...
//                elementGenerator.setWarnings(warnings);
        ...
        tool.SelectByConditionElementGenerator selectByConditionElementGenerator = new tool.SelectByConditionElementGenerator();
