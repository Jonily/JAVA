...
public interface MusicService {
   ...
   /*
     ...
     * 3 根据关键字查找音乐歌单
     */
    List<Music> findMusicByStr(String str);
    ...
    int deleteMusicById(int id);
     ...
     //6、查看中间表是否有该ID歌曲
    boolean findLoverMusicById(int musicId);

     /* 7
     * 删除服务器上的音乐时，同时在我喜欢的列表的数据库中进行删除*/
    int removeLoveMusicDelete(int musicId);

    /* 8 添加喜欢的音乐的时候，需要先判断该音乐是否存在
     * musicId
     */
    boolean findLoveMusicByMusicIdAndUserId(int userId, int musicId);
   ...
   /* 12
     ...
     * @param str
     * @return*/
    List<Music> findLoveMusicByStr(String str, int userId);
